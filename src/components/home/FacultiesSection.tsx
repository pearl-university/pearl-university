...
// 3D Slanted Mosaic Animation Variants
...
export const FacultiesSection: FC = () => {
  ...
  // Infinite auto-cycling timer (every 4.5s), pauses on hover
  useEffect(() => {
    if (isPaused) return
  ...
  return (
    <section
      ...
      className="relative w-full bg-white py-16 sm:py-24 md:py-28 px-4 sm:px-6 md:px-8 lg:px-12 overflow-hidden"
    >
      <div className="w-full max-w-7xl mx-auto flex flex-col justify-center">
        ...
        <motion.div
          ...
          className="max-w-4xl mx-auto text-center mb-12 sm:mb-16 md:mb-20 shrink-0"
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[42px] font-normal leading-[1.28] text-black tracking-[-0.01em] py-1 font-heading">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          {/* Left Column: Faculties Accordion List */}
              ...
              {FACULTIES.map((faculty, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <h3
                        className={`text-lg sm:text-xl md:text-2xl lg:text-[25px] font-normal transition-colors duration-300 font-heading ${isActive
                      ...
                      <HiChevronDown
                        className={`w-4 h-4 sm:w-5 sm:h-5 transition-transform duration-300 flex-shrink-0 ${isActive
                          ? 'text-black rotate-0'
          ...
          {/* Right Column: 3 Slanted Images Carousel with 3D perspective */}
          <div
            className="lg:col-span-6 relative w-full h-[300px] sm:h-[360px] md:h-[420px] lg:h-[480px]"
